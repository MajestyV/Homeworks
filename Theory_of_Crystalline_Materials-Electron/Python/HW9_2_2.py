...
#main is for plot data   for two loop, use append to store data into array. finally plot as scatter(for this case)
def main():
    x1=[]
    y1=[]
    for i in (0,1):
...
def y(ka,kb,i):
    kB = complex(np.cos(ka*2*math.pi),np.sin(ka*2*math.pi))
